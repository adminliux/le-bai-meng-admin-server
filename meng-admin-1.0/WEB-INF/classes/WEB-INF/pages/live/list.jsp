...
<div class="page-container">
    ...
    <form id="From">
		...
		<script type="text/html" id="f4">
            ...
            <a class="btn btn-success" href="${path}/page/live/course/add">发布直播</a>
        </div>
        <!-- 条件查询end -->
        ...
        <div class="mt-20" >
            ...
            <script type="text/html" id="f1">
                ...
                <tr>
                    ...
                    <td style="text-align:center;vertical-align:middle;">{{if good.shareSum == NULL}}0{{else if good.shareSum!=NULL}}{{good.shareSum}}{{/if}}</td>
                    <td style="text-align:center;vertical-align:middle;">{{if good.collectionSum == NULL}}0{{else if good.collectionSum!= NULL}}{{good.collectionSum}}{{/if}}</td>
                    <td style="text-align:center;vertical-align:middle;">
                    ...
                    <td style="text-align:center;vertical-align:middle;">
                        ...
                        <a href="${path}/page/live/course/update/live/byid?id={{good.id}}"><font color="#5a98de">修改</font></a>
                    </td>
                </tr>
                {{/each}}
            </script>
