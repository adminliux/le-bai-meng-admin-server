...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 视频列表 <span
        class="c-gray en">&gt;</span> 评论审核列表 <a class="btn btn-success radius r"
    ...
    <form id="From">
            ...
            <script type="text/html" id="f1">
                ...
                <tr>
                    ...
                    <td style="text-align:center;vertical-align:middle;">
                        <div style="width: 220px; overflow:auto;">{{good.content}}</div>
                    </td>
                    <td style="text-align:center;vertical-align:middle;">
                        {{if good.content==NULL}}无{{else}}
                        <u style="cursor:pointer" class="text-primary"
                           onclick="layer_show('简介','${path}/page/msg/detail?detail={{ASCII2Native good.content}}','800','600')"><font
                                color="#4169e1">查看详情</font></u>
                        {{/if}}
                    </td>
                    ...
                    <td style="text-align:center;vertical-align:middle;">
                        ...
                        <img src="${path}/resources/static/h-ui/images/validform/iconpic-right.png"
                             onClick="member_yes(this,'{{good.id}}')" title="通过">
                        {{/if}}
        ...
        <script type="text/javascript">
            ...
            function findUser(pageNum) {
                ...
                Project.ajax("/video/comment/admin/page", p, null, true).ajaxOK(function (data) {
            ...
            function member_stop(obj, id) {//id为用户的id，obj没用到
                layer.confirm('确认要删除该评论吗？', function (index) {
                    Project.ajax("/video/comment/delete", {id: id}, null, true).ajaxOK(function (data) {
            ...
            function member_yes(obj, id) {//id为用户的id，obj没用到
                var status = 'AUDITED';
                Project.ajax("/video/comment/update", {id: id, status: status}, null, true).ajaxOK(function (data) {
                    layer.msg('成功!', {icon: 6, time: 1000});
                    findUser();//刷新
                });
            }
