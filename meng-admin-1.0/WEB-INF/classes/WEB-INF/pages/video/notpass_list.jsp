	...
	<div class="mt-20" >
		...
		{{each data.list as good}}
			<tr>
				...
				<td style="text-align:center;vertical-align:middle;" ><div style="width: 220px; overflow:auto;">{{good.remarks}}</div></td>
				<td style="text-align:center;vertical-align:middle;">
					{{if good.remarks==NULL}}无{{else}}
					<u style="cursor:pointer" class="text-primary" onclick="layer_show('简介','${path}/page/msg/detail?detail={{good.remarks}}','800','600')"><font color="#4169e1">查看详情</font></u>
					{{/if}}
				</td>
