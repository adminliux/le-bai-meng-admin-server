	...
	<div class="mt-20" >
		...
		{{each data.list as good}}
			<tr>
				...
				<td style="text-align:center;vertical-align:middle;">{{if good.address==NULL}}暂无录播信息{{else if good.address!=NULL}}<u style="cursor:pointer" class="text-primary" onclick="member_show(' ','${path}/page/video/detail?address='+'{{good.address}}','10001','360','400')"><font color="#4169e1">查看</font></u>{{/if}}</td>
...
<script type="text/javascript">
    ...
    function findUser(pageNum){
		...
		Project.ajax("/live/course/admin/page",p,null,true).ajaxOK(function(data) {
