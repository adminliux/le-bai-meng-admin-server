...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 词库管理 <span class="c-gray en">&gt;</span> 词库列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	...
	<div class="text-c">
		...
		&nbsp
		<input type="text" name="word" placeholder="名称" style="width:7%">
		&nbsp日期范围：
	...
	<div class="mt-20" >
		...
		{{each data.list as good}}
			<tr>
				...
				<td style="text-align:center;vertical-align:middle;">{{good.word}}</td>
				<td style="text-align:center;vertical-align:middle;"><a onclick="deleteMsg({{good.id}})"><font color="#5a98de">删除</font></a></td>
...
<script type="text/javascript">
    ...
    function findUser(pageNum){
		...
		Project.ajax("/sensitive/words/page",p,null,true).ajaxOK(function(data) {
    ...
    function deleteMsg(id){
        if (confirm("你确定删除吗？")) {
            Project.ajax("/sensitive/words/remove/by/id",{id:id},null,true).ajaxOK(function(data) {
                findUser();
            },true);
        }
    }
