...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 背景图管理 <span class="c-gray en">&gt;</span> 修改背景图 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
...
<script type="text/javascript">
    ...
    function findUser(){
        ...
        Project.ajax("/video/back/img/find",{id:id}).ajaxOK(function(data) {
            ...
            $("#zhaopian").attr("src",data.data.imgUrl);
            $("input[name=previewImgUrl]").val(data.data.previewImgUrl);
            $("#zhaopian1").attr("src",data.data.previewImgUrl);
        });
    }
