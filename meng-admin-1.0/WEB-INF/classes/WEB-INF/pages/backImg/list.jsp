...
<div class="page-container">
	...
	<div class="text-c"> <span class="select-box inline">
		...
		<select name="classId" class="select" onchange="findUser()" id="classifyList">
		...
		&nbsp
		<input type="text" name="name" placeholder="名称" style="width:7%">
		</form>
	...
	<div class="mt-20" >
		...
		{{each data.list as good}}
			<tr>
				...
				<td style="text-align:center;vertical-align:middle;" >{{good.className}}</td>
				<td style="text-align:center;vertical-align:middle;">{{if good.imgUrl==NULL}}无{{else if good.imgUrl!=NULL}}<a class="sit-preview" href="{{good.imgUrl}}" onMouseOver="biggerr()"><img src="{{good.imgUrl}}" data-preview-url="{{good.imgUrl}}" style="cursor:pointer;width:60px;height:60px;"/></a>{{/if}}</td>
				<td style="text-align:center;vertical-align:middle;">{{if good.previewImgUrl==NULL}}无{{else if good.previewImgUrl!=NULL}}<a class="sit-preview" href="{{good.previewImgUrl}}" onMouseOver="biggerr()"><img src="{{good.previewImgUrl}}" data-preview-url="{{good.previewImgUrl}}" style="cursor:pointer;width:60px;height:60px;"/></a>{{/if}}</td>
				<td style="text-align:center;vertical-align:middle;">{{$timestampFormatYMDHM good.gmtDatetime}}</td>
				<td style="text-align:center;vertical-align:middle;">
					<a href="${path}/page/back/img/update?id={{good.id}}"><font color="#7fff00">修改</font></a>
