...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 课程管理 <span class="c-gray en">&gt;</span>  获取按月人数统计结果 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	...
	<div class="text-c"> <span class="select-box inline">
		...
		<form id="From">
		&nbsp日期范围：
		<input type="text" class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM'})" name="stMonth" style="width: 30%; height: 30px" placeholder="开始时间" />
		-
		<input type="text" class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM'})" name="edMonth" style="width: 30%; height: 30px" placeholder="结束时间" />
		&nbsp
		...
		<br>
		<font color="red">返回结果包含结束月份的数据，开始月份和结束月份可以相同，返回结果不包括当前月的数据。</font>
	</div>
	<!-- 条件查询end -->
	<div class="mt-20" >
		...
		{{each data as good}}
			<tr>
				...
				<td style="text-align:center;vertical-align:middle;">{{good.month}}</td>
