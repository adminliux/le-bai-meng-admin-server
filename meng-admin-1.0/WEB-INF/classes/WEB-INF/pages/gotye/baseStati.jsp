...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 课程管理 <span class="c-gray en">&gt;</span>  获取流量和带宽日统计结果 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
	...
	<div class="mt-20" >
		...
		{{each data as good}}
			<tr>
				...
				<td style="text-align:center;vertical-align:middle;">{{good.date}}</td>
				<td style="text-align:center;vertical-align:middle;">{{good.useFlux}}</td>
				<td style="text-align:center;vertical-align:middle;">{{good.maxBandwidth}}</td>
			</tr>
		{{/each}}
		</script>
...
<script type="text/javascript">
    function findUser(){
		...
		Project.ajax("/gotye/get/base/stati",fromList,null,true).ajaxOK(function(data) {
