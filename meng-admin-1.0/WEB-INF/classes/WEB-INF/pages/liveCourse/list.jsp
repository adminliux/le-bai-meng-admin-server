...
<div class="page-container">
	...
	<div class="text-c">
		...
		&nbsp
		<input type="text" name="name" placeholder="课程名称" style="width:10%">
	...
	<div class="mt-20" >
		...
		{{each data.list as good}}
			<tr>
				...
				<td style="text-align:center;vertical-align:middle;">{{good.roomId}}</td>
				<td style="text-align:center;vertical-align:middle;">{{good.signUpNumber}}</td>
				...
				<td style="text-align:center;vertical-align:middle;">{{if good.address==NULL}}暂无录播信息{{else if good.address!=NULL}}<u style="cursor:pointer" class="text-primary" onclick="member_show(' ','${path}/page/video/detail?address='+'{{good.address}}','10001','1060','800')"><font color="#4169e1">{{good.address}}</font></u>{{/if}}</td>
				<td style="text-align:center;vertical-align:middle;">{{good.price}}</td>
				<td style="text-align:center;vertical-align:middle;">{{$timestampFormatYMDHM good.liveDatetime}}</td>
				...
				<td style="text-align:center;vertical-align:middle;">
					...
					<u style="cursor:pointer" class="text-primary" onclick="layer_show('简介','${path}/page/msg/detail?*jsp={{good.intro}}','800','600')"><font color="#4169e1">查看简介</font></u>
					{{/if}}
				</td>
				<td style="text-align:center;vertical-align:middle;">{{$timestampFormatYMDHM good.gmtDatetime}}</td>
				<td style="text-align:center;vertical-align:middle;"><a onclick="tiaozhuan1({{good.id}})"><font color="red">添加学员</font></a>
					<a href="${path}/page/live/course/update/byid?id={{good.id}}">修改</a>
...
<script type="text/javascript">
    ...
    function tiaozhuan1(id){//id为用户的id，obj没用到
        window.location.href="${path}/page/live/course/user?liveCourseId="+id;
    }
