...
<div class="page-container">
	...
	<!-- 条件查询end -->
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="1">本页共有:<strong id="size"></strong> 条</span><a class="btn btn-success" onclick="tianjia()">确认添加学员</a> <span class="r">共有数据：<strong id="total"></strong> 条</span> </div>
	<div class="mt-20" >
		<table class="table table-border table-bordered table-bg table-hover" style="white-space: nowrap">
			<thead>
				<tr class="text-c">
					<th width="25"><input type="checkbox" onclick="allSelect()" name="aa"></th>
					<th width="80">ID</th>
					<th width="75">昵称</th>
		...
		{{each data.list as good}}
			<tr>
				<td style="text-align:center;vertical-align:middle;"><input type="checkbox" value="{{good.id}}" name="bb"></td>
