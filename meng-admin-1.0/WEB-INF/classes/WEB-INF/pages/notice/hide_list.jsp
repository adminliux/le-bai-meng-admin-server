...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 广播管理 <span class="c-gray en">&gt;</span> 待审核广播列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	...
	<div class="text-c"> <span class="select-box inline">
		...
		&nbsp
		<input type="text" name="classify" placeholder="分类名" style="width:7%">
		</form>
	...
	<div class="mt-20" >
		...
		{{each data.list as good}}
			<tr>
				...
				<%--{{if good.classify=="比赛"}}<td style="text-align:center;vertical-align:middle;"><u style="cursor:pointer" class="text-primary" onclick="member_show(' ','${path}/page/video/detail?address='+'{{good.bannerImages}}','10001','360','400')"><font color="#4169e1">查看视频</font></u></td>
				{{else}}
				&lt;%&ndash;<td style="text-align:center;vertical-align:middle;"><u style="cursor:pointer" class="text-primary" onclick="member_show(' ','${path}/page/notice/imgs?id='+'{{good.id}}','10001','360','400')"><font color="#4169e1">查看</font></u></td>&ndash;%&gt;
				...
				{{/if}}--%>
				<td style="width: 100px" >{{good.title}}</td>
				...
				<td style="text-align:center;vertical-align:middle;">
					<a onclick="updateStatus({{good.id}})"><font color="red">通过</font></a>
