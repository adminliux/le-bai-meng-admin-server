...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 评论审核 <span class="c-gray en">&gt;</span> 评论审核列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
        ...
        <script type="text/html" id="f1">
            ...
            <tr>
                ...
                <td style="text-align:center;vertical-align:middle;">
                    ...
                    <u style="cursor:pointer" class="text-primary" onclick="layer_show('简介','${path}/page/msg/*jsp?*jsp={{good.content}}','800','600')"><font color="#4169e1">查看详情</font></u>
                    {{/if}}
                </td>
    ...
    <script type="text/javascript">
        ...
        function findUser(pageNum){
            ...
            Project.ajax("/notice/comment/qcb/admin/page", p,null,true).ajaxOK(function(data) {
...
//                updateType();
        ...
        function updateType(){
            var type="VCOMMENT";
            Project.ajax("/notice/view/already", {type:type},null,true).ajaxOK(function(data) {
        ...
        function member_stop(obj,id){//id为用户的id，obj没用到
            layer.confirm('确认要删除该评论吗？',function(index){
                Project.ajax("/notice/comment/qcb/delete",{id:id},null,true).ajaxOK(function(data) {
        ...
        function member_yes(obj,id){//id为用户的id，obj没用到
            var status ='AUDITED';
            Project.ajax("/notice/comment/qcb/update",{id:id,status:status},null,true).ajaxOK(function(data) {
                layer.msg('成功!',{icon: 6,time:1000});
                findUser();//刷新
            });
        }
