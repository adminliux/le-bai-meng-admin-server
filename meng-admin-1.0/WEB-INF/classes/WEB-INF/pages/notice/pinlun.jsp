...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 广播列表 <span class="c-gray en">&gt;</span> 评论列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
    ...
    <script type="text/javascript">
        ...
        function findUser(pageNum){
            var videoId='${id}';
            Project.ajax("/notice/comment/qcb/page", {videoId:videoId,pageNum:pageNum},null,true).ajaxOK(function(data) {
